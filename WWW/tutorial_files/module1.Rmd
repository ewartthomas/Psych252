...
Take a moment to continue exploring this data set. What else can you learn about it? Can you think of a way to distinguish between the different mechanisms posed above (hint: we might want to look at the *proportion* of different kinds of deaths as opposed to raw counts)? Are certain ways of formatting the data better for answering certain questions?
